 ...
 * User Manager class
 * 
 * This class is responsible for user data storage and retrieval, it contains model codes for user manipulation
 * including some user controller functions like authnetication, registration checkup and login check,
 * 
 * It is a mini-god class for user manipulation
 */
    class UserManager{
        protected $filename;
        public $error;
        ...
        public function addUser($username, $password, $email){
            ...
            $id = $this->getLastId() + 1;
            $content = file_get_contents($this->filename); //file upload service
